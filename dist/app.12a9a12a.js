  ...
  zUnb(t, e, n) {
    ...
    n.r(e); let r = n('Kw5r'),
      ...
      b = g.getContext('2d'); Object.assign(g, { width: 28, height: 28, style: 'border: 1px solid blue' }); var w = new r.a({
        ...
        methods: {
          load_model() { return h.a(this, void 0, void 0, function () { let t; return h.b(this, function (e) { switch (e.label) { case 0: return t = this, [4, m.loadModel('https://raw.githubusercontent.com/Plasmatium/tfjs-exploration/master/src/assets/shared_model/model.json')]; case 1: return t.model = e.sent(), this.modelLoaded = !0, [2]; } }); }); },
          getImgTensor() {
            w.ctx; let t = w.cv,
          ...
          predict() {
            return h.a(this, void 0, void 0, function () {
              let t,
                e,
                n; return h.b(this, function (r) { switch (r.label) { case 0: return t = this.model.predict(this.getImgTensor()), t.print(), [4, t]; case 1: return e = r.sent(), [4, m.argMax(e, 1)]; case 2: return [4, r.sent().data()]; case 3: return n = r.sent(), [2, n]; } });
            });
          },
        },
      }),
      x = w; Object.assign(window, { axios: p.a }); let _ = r.a.extend({
        ...
        methods: {
          predict() {
            return h.a(this, void 0, void 0, function () {
              let t,
                e; return h.b(this, function (n) { switch (n.label) { case 0: return [4, x.predict()]; case 1: return t = n.sent(), this.predNum = t[0], e = this.bus.ctx, setTimeout(() => { e.clearRect(0, 0, 400, 400); }, 1e3), [2]; } });
            });
          },
          mockLoading() {
      ...
      j = _,
      y = (n('+Fh9'), Object(a.a)(j, l, f, !1, null, '7176ea6f', null)),
      T = y.exports; r.a.use(d.a); const O = new d.a({ mode: 'history', routes: [{ path: '/tfjs-exploration', name: 'home', component: T }] }); r.a.config.productionTip = !1, new r.a({ router: O, render(t) { return t(s); } }).$mount('#app');
  },
}));
